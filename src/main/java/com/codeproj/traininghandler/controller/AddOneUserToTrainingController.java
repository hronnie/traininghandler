...
@Controller
@RequestMapping("/manageTraining/addOneUserToTraining")
public class AddOneUserToTrainingController {
	private static final Logger logger = Logger.getLogger(AddOneUserToTrainingController.class);
