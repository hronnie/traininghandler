...
@Controller
@RequestMapping("/manageTraining/showEligibleTrainees")
public class ShowTraineesEligibleForTrainingController {

	private static final Logger logger = Logger.getLogger(ShowTraineesEligibleForTrainingController.class);
