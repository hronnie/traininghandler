...
app.controller('thTrainingTypeController', function($scope, $filter, Restangular) {
	...
	var trainingTypeRest = Restangular.all('traininghandler/rest/trainingtype/getAll');
	//var trainingTypesRest = Restangular.allUrl('t', 'http://66.172.27.212:8080/traininghandler/rest/trainingtype/getAll');
	$scope.trainingTypes = trainingTypeRest.getList(); 
//	 [
