...
*/
app.controller('thTrainingTypeController', function($scope, $filter, $http) {
 $scope.trainingTypes = [
...
app.run(function($httpBackend) {
  ...
  $httpBackend.whenPOST('http://localhost:8080/traininghandler/rest/trainingtype/create/').respond(function(method, url, data) {
